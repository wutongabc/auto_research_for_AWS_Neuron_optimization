...
class MLPTKGConstants(nl.NKIObject):
    ...
    def calculate_gate_up_tiles(
        ...
        if sbm.is_auto_alloc():
            ...
            # Do not reserve columns beyond this program's H shard. The
            # selective T=1 path otherwise allocates HTile=2048 for H=1024
            # and uses only half of every gate/up weight tile.

...
# Serve gpt-oss-20B in SHORT mode (TP=8, 16K context)
# Official single-instance parameters from vLLM-Neuron tutorial, adapted for prefill benchmarking.
...
echo "=== Serving gpt-oss-20B (SHORT: TP=$TP_SIZE, ctx=$MAX_MODEL_LEN) ==="

...
# Serve GPT-OSS-120B with official-like params (TP=16, 16K context, BF16)
...
SERVE_ARGS=(
    ...
    --additional-config "{\"neuron_config\": {\"kv_segment_size_buckets\": [8192], \"num_batched_tokens_buckets\": [8192], \"num_seqs_buckets\": [1]}}"
)

echo "=== Serving GPT-OSS-120B (Official: TP=$TP_SIZE, ctx=$MAX_MODEL_LEN, BF16) ==="
echo "  Port: $PORT"

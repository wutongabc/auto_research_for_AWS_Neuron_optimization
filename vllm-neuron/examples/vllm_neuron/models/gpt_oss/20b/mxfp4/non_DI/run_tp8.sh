#!/bin/bash
# gpt-oss 20B single-instance (non-DI) server — TP8.
#
...
# single-node disaggregated-inference config in ../single_node_DI/ instead.
#
# Mirrors the "Deploy on a single instance (non-DI)" section of the gpt-oss
# tutorial: docs/tutorials/tutorial-gpt-oss.md
#
# This is the same single-instance config as gpt-oss 120B (see
# ../../../120b/mxfp4/non_DI/run_tp8.sh); only the model identifier differs.
# Runs on Trn3 (MXFP4) or Trn2 (change "quantization" to "bf16").
